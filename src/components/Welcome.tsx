  ...
  return (
    <div>
      <div className="py-5 px-5">
        ...
        <div className="lg:flex 2xl:justify-center  justify-between items-center">
          ...
          <div className="lg:px-5 mt-3 lg:mt-0 lg:w-1/2 text-justify">
            <p>
              "Dear Students, Parents, and Guardians, It is with great pride and
              excitement that we welcome you to VICMOB SCHOOLS. Our institution
              is more than just a place of learning; it's a nurturing
              environment where dreams take shape and futures are forged. VICMOB
              SCHOOLS is a comprehensive institution, encompassing preschool,
              primary, and secondary education. We hold ourselves to the highest
