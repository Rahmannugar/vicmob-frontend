  ...
  return (
    <div>
      ...
      <div className="md:flex items-center px-5 md:px-0 lg:space-x-20 md:space-x-10 justify-center mt-6 md:mt-10">
        {/* primary school */}
        <div
          className="flex flex-col relative space-y-4 border-4 border-blue-900
"
        >
          <img
        ...
        {/* secondary school */}
        <div className="mt-10 md:mt-0 flex flex-col relative space-y-4 border-4 border-blue-900">
          <img
